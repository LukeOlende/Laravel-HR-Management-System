        ...
        <div class="topbar-left">
            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-leave-type/{id}')
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-link" style="color: black;font-size: 15px">Leave
                    </li>
                    <li class="breadcrumb-current-item" style="color: black; font-size: 15px"> Edit {{$result->leave_type}} leave type</li>
                </ol>
            @else
            <ol class="breadcrumb">
                <li class="breadcrumb-icon">
                ...
                <li class="breadcrumb-link" style="color:black; font-size: 15px">Leave</li>
                <li class="breadcrumb-current-item" style="color:black;font-size: 15px"> Add Leave Type </li>
            </ol>
            @endif
        </div>
    </header>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-leave-type/{id}')
                                <span class="panel-title hidden-xs" style="color: black;"> Edit Leave Type </span>
                                @else
                                <span class="panel-title hidden-xs" style="color: black;"> Add Leave Type </span>
                                @endif
                        </div>
                                ...
                                <div class="panel-body p25 pb10">
                                    ...
                                    {!! Form::open(['class' => 'form-horizontal']) !!}
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                @if(\Route::getFacadeRoot()->current()->uri() == 'edit-leave-type/{id}')
                                                    <input type="text" name="leave_type" id="input002" 
                                                    class="select2-single form-control" value="@if($result && $result->leave_type){{$result->leave_type}}@endif" required>
                                                @else
                                                    <input type="text" name="leave_type" id="input002" 
                                                    class="select2-single form-control" placeholder="Leave Type" required>
                                                @endif
                                            </div>
                                        </div>
